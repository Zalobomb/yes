        ...
        <?php endif; ?>
				...
				<?php else : ?>
					<article class="search-error">
						<header class="article-header"><h3 class="h3"><?php echo __('Oops, Nothing Found!', 'metroino'); ?></h3></header>
                        <div class="article-body">
							<p><?php echo __( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'metroino'); ?></p>
                        </div>
						<?php get_search_form(); ?>
                     </article>
				<?php endif; ?>
